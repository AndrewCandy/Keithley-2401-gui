...
src_sweep_range_lbox = Listbox(c, listvariable=rnames, height=5, selectmode=SINGLE, exportselection=False)
voltage_mode_label = Label(c, text='Voltage Mode:')
src_voltage_mode_lbox = Listbox(c, listvariable=mnames, height=5, selectmode=SINGLE, exportselection=False)
sweep_space_label = Label(c, text='Sweep Space:')
src_sweep_space_lbox = Listbox(c, listvariable=snames, height=5, selectmode=SINGLE, exportselection=False)
